  ...
  return (
    <div className="min-h-screen bg-[#061220]">
      ...
      <main>
        ...
        <div className="container mx-auto px-4 py-16 text-white">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              ...
              >
                <div className="bg-[#0c2137]/50 p-4 rounded-lg border border-[#1e3a5f] text-center">
              ...
              >
                ...
                <Link to="/library">
                  <Button
                    size="lg"
                    className="bg-[#1e3a5f] hover:bg-[#2e4a6f] text-white"
                  >
                    View Documentation
                    <ArrowRight className="ml-2 h-4 w-4" />
                  </Button>
            ...
            >
              <div className="w-full h-[400px] relative overflow-hidden rounded-xl bg-gradient-to-br from-[#0c2137] to-[#061220] shadow-2xl border border-[#1e3a5f]">
        ...
        {/* Stats Section */}
        <div className="container mx-auto px-4 py-16 border-t border-[#1e3a5f]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            >
              ...
              <div className="text-gray-400">Active Installations</div>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
